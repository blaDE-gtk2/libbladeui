...
#include <libbladeui/xfce-dialogs.h>
#include <libbladeui/xfce-gtk-extensions.h>
#include <libbladeui/xfce-gdk-extensions.h>
#include <libbladeui/xfce-spawn.h>
#include <libbladeui/libbladeui-private.h>
#include <libbladeui/libbladeui-alias.h>

#include "libbladeui-resources.h"
                           ...
                           GString   *uri)
{
  ...
  path = g_find_program_in_path ("blxo-open");
  if (G_LIKELY (path != NULL))
    ...
    {
      /* not very likely to happen, but it is possible blxo is not installed */
