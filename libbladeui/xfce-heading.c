...
_xfce_heading_set_icon (XfceHeading *heading,
                        GdkPixbuf   *icon)
{
  _libbladeui_return_if_fail (XFCE_IS_HEADING (heading));
  _libbladeui_return_if_fail (icon == NULL || GDK_IS_PIXBUF (icon));
...
{
  _libbladeui_return_if_fail (XFCE_IS_HEADING (heading));
  _libbladeui_return_if_fail (subtitle == NULL || g_utf8_validate (subtitle, -1, NULL));
...
{
  _libbladeui_return_if_fail (XFCE_IS_HEADING (heading));
  _libbladeui_return_if_fail (title == NULL || g_utf8_validate (title, -1, NULL));
